...
- [x] Flow suites (each its own file):
  ...
  - Sessions: list shows device metadata; revoke one (other device's refresh fails);
    revoke all-but-current; password change preserves current and revokes siblings; reset
