...
- [x] `LockoutPolicy.RegisterFailure` body — fixed-window transition implemented and covered at the threshold, active-lock, exact-expiry, expired-lock fresh-allowance, success-reset and disabled-policy boundaries.
